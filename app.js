...
client.on('message', async msg => {
  ...
  if (msg.hasMedia && msg.id.remote != "status@broadcast") {
    ...
    var config = {
        method: 'post',
        url: 'https://763fceac0a65.ngrok.io/api/Upload/uploadFileWhats',
        headers: {
  ...
  if(msg.id.remote != "status@broadcast"){
    var config = {
      method: 'post',
      url: 'https://c9371fde947c.ngrok.io/api/WhatsWeb/Receberheruku',
      headers: {
          'Content-Type': 'application/json'
      },
      data: msg
...
client.on("message_ack", (msg, ack) => {
  if(ack == 1 && msg.deviceType == "android"){
    var config = {
      method: 'post',
      url: 'https://c9371fde947c.ngrok.io/api/WhatsWeb/SincronizaWW',
      headers: {
          'Content-Type': 'application/json'
      },
      data: msg
